// src/test/java/iwkms/shop/ecommerce/user/controller/AuthControllerTest.java
...
import iwkms.shop.ecommerce.shared.exception.GlobalExceptionHandler; // Добавьте, если нужно для 401
...
import iwkms.shop.ecommerce.user.service.JwtService; // <-- ИМПОРТ
...
class AuthControllerTest {
    ...
    void login_ShouldReturnUnauthorized_WhenCredentialsAreInvalid() throws Exception {
        ...
        // Имитируем, что AuthenticationManager бросил исключение
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                        ...
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(loginDto)))
                // Мы ожидаем 401, так как это стандартный ответ на BadCredentialsException
